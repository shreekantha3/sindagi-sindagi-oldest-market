# Sindagi Oldest Market — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-sindagi-oldest-market/
- **Repo:** `shreekantha3/sindagi-sindagi-oldest-market` (branch `main` = source, `gh-pages` = deployed bundle)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-sindagi-oldest-market/'` for GitHub Pages project-site hosting.
